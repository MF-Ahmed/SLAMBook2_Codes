...
/************************************************
  ...
  * Although the entire graph can be read directly through the load function, we still implement the reading code 
    ourselves in order to gain a deeper understanding
  * This section uses Lie algebra to express the pose graph, and the way of nodes and edges is custom
  *************************************************/
typedef Matrix<double, 6, 6> Matrix6d;
// Find the approximation of J_R^{-1} for a given error
...
int main(int argc, char **argv) {
    ...
    // Because custom vertices are used and not registered with g2o, save yourself here to implement
